...
const ProductManagement = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8081/api/v1/analytics-service/admin/product?page=0&size=100", {
        headers: {
  ...
  const handleDelete = async (id, name) => {
    ...
    try {
      ...
      await axios.delete(`http://localhost:8081/api/v1/analytics-service/admin/product/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
